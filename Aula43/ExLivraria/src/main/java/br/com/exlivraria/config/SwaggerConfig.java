	...
	public Docket api() {
		...
		public ApiInfo apiInfo() {
			return new ApiInfo("ExLivraria - Spring Boot 2.1.3",
					"Criação do Grupo 3 da Digital House - Integrantes - Achiles Martins, Adriano Henrique, Bruno Sabiá, Igor Aguiar, Rafael Alheiros ",
					"version v1",
					"termsOfServiceUrl",
					new Contact("Expansão Livraria", "www.site.com.br", "email@email.com"),
					"license of API",
					"license of URL",
