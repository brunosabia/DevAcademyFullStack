...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		.and()
			...
			.antMatchers("/auth/signin","/clients", "swagger-ui.html**", "/api/books/v1/**").permitAll() //vamos passar os padrões que serão permitidos
			.antMatchers("/users").authenticated() //pra chegar aqui precisa estar authenticated
			.antMatchers("/users","/api/books/v1/delete","/clients/delete").denyAll() //ngm pode acessar
		.and()
